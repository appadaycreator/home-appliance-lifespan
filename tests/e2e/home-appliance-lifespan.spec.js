...
const SVC_URL = "https://appadaycreator.com/home-appliance-lifespan/";
const SVC_NAME = "家電買い替え時期診断";

test.describe("家電買い替え時期診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("home-appliance-lifespan");
